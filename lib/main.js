...
var defaults = {
  ...
  svg: true,                     // return svg output?
  svgNode: true,              // DOM element for SVG output?
...
console.log(require.resolve('mathjax'));

//var MathJaxPath = url.resolve("file:///","file:"+require.resolve('mathjax'));
//var MathJaxPath = url.resolve("file:///","file:"+"C:/Users/bapoczos/node_modules/mathjax/MathJax.js");
...
function ConfigureMathJax() {
  window.MathJax = {
    ...
    SVG: {useFontCache: false, useGlobalCache: false, EqnChunk: 1000000, EqnDelay: 0},
